...
This model is still used for quick changes/prototyping in lots of non-html contexts. Need to set up kubenetes a certain way? You might make some changes and quickly deploy with `kubectl`.  
